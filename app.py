...
try:
    ...
    ax1.barh(df_filtrado_sorted["Nombre_comuna"], df_filtrado_sorted["YEAR_2022"], color="#1f77b4", height=1.0)
    ax1.invert_yaxis()
    ...
    ax2.barh(df_filtrado_sorted_var["Nombre_comuna"], df_filtrado_sorted_var["Var_Porc"], color="#ff7f0e", height=1.0)
    ax2.invert_yaxis()
